...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.169e312d.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Navbar;
  return renderTemplate`${maybeRenderHead()}<nav class="border-b-2 py-5 md:py-5 px-5 md:px-0 bg-white astro-5KNYCIEN">
  <div class="md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 flex flex-wrap items-center justify-between astro-5KNYCIEN">
...
<footer class="bg-[#31393C] py-10 md:py-16 lg:py-20 astro-K2F5ZB5C">
    ...
    <div class="md:max-w-7xl mx-5 md:mx-auto md:px-24 2xl:px-0 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-7lg:gap-10 text-white astro-K2F5ZB5C">
		 ...
		 <div class=" astro-K2F5ZB5C">
            <h4 class="!text-base text[#F7FFFF] font-bold astro-K2F5ZB5C">Discover</h4>
                <div class="grid gap-2 md:gap-2 lg:gap-3 mt-2 astro-K2F5ZB5C">
                    ...
                    <a href="/erpnext-implementation-partner" class="text-sm astro-K2F5ZB5C">ERRNext Implementation Partner</a>
                </div>
        </div>
         <div class="astro-K2F5ZB5C">
...
<section class="bg-[#04000E] astro-K2F5ZB5C">
    <p class="md:max-w-7xl md:mx-auto md:px-24 lg:px-0 text-center p-2 astro-K2F5ZB5C">
...
const brilliant_working_new = {"src":"/_astro/brilliant_working.898f8b9c.jpg","width":938,"height":693,"format":"jpg"};

const $$Astro = createAstro();
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "About Sanskar Technolabs | ERPNext software development company", ",": true, "keyword": "erp implementation, Erpnext solution company, ERPNext development services, Erpnext solution company, ERPNext software development company, Servicenow implementation services", ",": true, "description": " Here\u2019s the subtle glimpses about the journey of Sanskar Technolabs, The best ERPNext Implementation partner.", ",": true, "canonical_href": "https://sanskartechnolab.com/about", "class": "astro-KH7BTL4R" }, { "default": ($$result2) => renderTemplate`
	${maybeRenderHead()}<section class="section-bg-right astro-KH7BTL4R">
		<div class="hidden lg:flex h-[calc(100vh-10vh)] lg:py-[0rem] xl:py-[24rem] 2xl:py-[24rem] relative flex-wrap items-center  astro-KH7BTL4R">
			...
			<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 flex container astro-KH7BTL4R">
		...
		<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 flex lg:hidden flex-wrap items-center justify-between pt-10 pb-5 h-[calc(100vh-9vh)] astro-KH7BTL4R">
		...
		<section class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 py-[3.125rem] md:py-[2rem] lg:py-[4rem] astro-KH7BTL4R">
      <div class="md:text-center sm:text-left astro-KH7BTL4R">
	  ...
	  <p class="pt-6 md:pt-8 lg:pt-12 pb-6 md:pb-8 lg:pb-12 text-center font-semibold text-[1.25rem] md:text-[1.50rem] lg:text-[1.75rem] leading-7 md:leading-8 lg:leading-9 text-[#31393C] astro-KH7BTL4R">Sneak Peek into our growing numbers!</p>

      <div class="  astro-KH7BTL4R">
        <div class="swiper-container !overflow-hidden astro-KH7BTL4R">
          <div class="swiper-wrapper ml-0 md:ml-0 astro-KH7BTL4R">
            <div class="swiper-slide p-3 astro-KH7BTL4R">
              <div class="let-shadow w-auto md:w-64 h-64 p-5 grid justify-items-center astro-KH7BTL4R">
            ...
            <div class="block xl:hidden swiper-slide  p-3 astro-KH7BTL4R">
              <div class="let-shadow w-auto md:w-64 h-64 p-5 grid justify-items-center astro-KH7BTL4R">
							${renderComponent($$result2, "Image", $$Image, { "src": fifty, "alt": "12+ Years of Excellence", "width": 64, "height": 60, "class": "astro-KH7BTL4R" })}	
							<p class="text-[3.5rem] md:text-[3.75rem] lg:text-[4rem] font-bold astro-KH7BTL4R">50+</p>
							<p class="font-normal text-base astro-KH7BTL4R">Dedicated team</p>
      ...
      <div class="justify-center  flex gap-3 mt-5 -mb-7 astro-KH7BTL4R">
					<!-- <Image loading="eager"  src={previousbtn} alt="previousbtn" id="prev" />
				<Image loading="eager"  src={nextbtn} alt="nextbtn" id="next" /> -->
					<button class="prev-button rounded-full border border-[#3E96F4] p-3 text-[#3E96F4] hover:bg-[#3E96F4] hover:text-white astro-KH7BTL4R">
						<span class="sr-only astro-KH7BTL4R">Previous Slide</span>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-3 w-3 rtl:rotate-180 astro-KH7BTL4R">
							<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" class="astro-KH7BTL4R"></path>
						</svg>
					</button>

					<button class="next-button rounded-full border border-[#3E96F4] p-3 text-[#3E96F4] hover:bg-[#3E96F4] hover:text-white astro-KH7BTL4R">
						<span class="sr-only astro-KH7BTL4R">Next Slide</span>
						<svg class="h-3 w-3 rtl:rotate-180 astro-KH7BTL4R" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							<path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="astro-KH7BTL4R"></path>
						</svg>
					</button>
				</div>
    </section>
		...
		<section class="section-bg-left py-[3.125rem] md:py-[2rem] lg:py-[4rem] astro-KH7BTL4R">
			<div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10  mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 astro-KH7BTL4R">
				<div class="astro-KH7BTL4R">
		...
		<section class="section-bg-left py-[3.125rem] md:py-[6.25rem] lg:py-[3.125rem] astro-KH7BTL4R">
            <div class="hidden lg:block md:max-w-7xl md:mx-auto md:px-24 astro-KH7BTL4R">
                <div class="bg-partner bg-cover bg-no-repeat bg-center md:bg-contain md:bg-right h-96 grid p-16 pt-24 items-center astro-KH7BTL4R">
            ...
            <div class="block lg:hidden md:max-w-7xl md:mx-auto md:px-24 mt-10 bg-[#3E96F4] pb-10 astro-KH7BTL4R">
                <div class="mx-5 astro-KH7BTL4R">
                    ${renderComponent($$result2, "Image", $$Image, { "src": cta_mobile, "alt": "cta-mobile", "class": "astro-KH7BTL4R" })}
                    <h2 class="text-2xl md:text-3xl lg:text-4xl !leading-[2rem] md:!leading-[2.75rem] text-white font-semibold astro-KH7BTL4R">
                       Partner with us to unleash the potential of the best tech for your business!
                </h2>
                    	<div class="text-white text-base font-semibold flex items-center gap-3 mt-3 md:mt-5 font-inter astro-KH7BTL4R">
							<div class="flex justify-between bg-white rounded-lg px-4 py-2 w-56 astro-KH7BTL4R">
										<a href="/contact-us" class="text-[#3E96F4] font-semibold text-base font-inter astro-KH7BTL4R">Book a free demo.</a>
										${renderComponent($$result2, "Image", $$Image, { "src": right_arrow, "alt": "Drive To Innovation", "width": 6, "height": 12, "class": "astro-KH7BTL4R" })}
									</div>
							</div>
		...
		<section class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 text-center py-[3.125rem] md:py-[2rem] lg:py-[4rem] astro-KH7BTL4R">
		...
		<section class="py-[3.125rem] md:py-[2rem] lg:py-[4rem] astro-KH7BTL4R">
			<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 astro-KH7BTL4R">
				<h2 class="text-center text-lg md:text-xl lg:text-2xl font-semibold mb-1 md:mb-1 lg:mb-2 mx-4 md:mx-20 lg:mx-48 astro-KH7BTL4R">Assets of Sanskar Technolabs - Brilliant Minds working to bring <br class="hidden md:hidden lg:hidden xl:block astro-KH7BTL4R"> your ideas to life.</h2>
				...
				<div class="flex justify-center astro-KH7BTL4R">
					${renderComponent($$result2, "Image", $$Image, { "src": brilliant_working_new, "alt": "Sanskar working", "width": 924, "height": 662, "class": "astro-KH7BTL4R" })}
				</div>
			</div>
		</section>
		...
		<section class="section-bg-center astro-KH7BTL4R">
			<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 py-[3.125rem] md:py-[2rem] lg:py-[4rem] astro-KH7BTL4R">
		...
		<section class="py-[3.125rem] md:py-[3.125rem] lg:py-[3.125rem] xl:py-[6.25rem] astro-KH7BTL4R">
			<div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 xl:gap-0 mx-5 md:max-w-7xl md:mx-auto md:px-24 2xl:px-0 astro-KH7BTL4R">
            ...
            ${renderComponent($$result2, "Image", $$Image, { "class": " astro-KH7BTL4R", "src": impactful_story, "alt": "Impactful Story", "width": 483, "height": 486 })}
				...
				<div class="astro-KH7BTL4R"> 
					...
					<h2 class="text-[#31393C] pb-2 md:pb-4 lg:pb-6 font-semibold  text-2xl md:text-3xl lg:text-4xl leading-[1.75rem] md:leading-[2.25rem] lg:leading-[2.75rem] astro-KH7BTL4R">12 Years of Excellence & <br class="hidden md:hidden lg:hidden xl:block astro-KH7BTL4R"> Innovation!</h2>
...
export { $$Image as $, BaseSSRService as B, $$Layout as a, right_arrow as b, cta_mobile as c, down_arrow as d, error as e, about as f, isRemoteImage as i, metadata as m, right as r };
