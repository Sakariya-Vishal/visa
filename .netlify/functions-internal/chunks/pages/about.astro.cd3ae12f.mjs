...
import 'node:stream';
import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, b as addAttribute, d as renderComponent, e as renderSlot, f as renderHead } from '../astro.497f965b.mjs';
import 'html-escaper';
/* empty css                           */
...
async function getImage(transform) {
  ...
  if (!loader) {
    const { default: mod } = await import('./endpoint.js.bf5d6a21.mjs').then(n => n.s).catch(() => {
      throw new Error(
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav class="border-b-2 p-5 bg-white astro-5KNYCIEN">
    <div class="md:max-w-7xl md:mx-auto md:px-24 flex flex-wrap items-center justify-between astro-5KNYCIEN">
        ...
        <div class="block lg:hidden mt-5 md:mt-0 w-2/12 md:w-auto astro-5KNYCIEN">
            <button class="flex items-center px-3 py-2 border rounded font-bold hover:text-black hover:border-white menu astro-5KNYCIEN">
                <svg class="fill-current h-3 w-3 astro-5KNYCIEN" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" class="astro-5KNYCIEN"></path></svg>
            </button>
        </div>
        <div class="w-full hidden lg:flex lg:items-center lg:w-auto pb-0 md:pb-4 lg:pb-0 font-semibold text-base astro-5KNYCIEN" id="menu">
            <ul class="!leading-8 lg:flex-grow astro-5KNYCIEN" id="main-menu">
                    ...
                    <span class="group relative inline-block astro-5KNYCIEN">
                      ...
                      <ul class="sub-menu absolute z-10 hidden submenu-bg lg:top-[4.1rem] py-2 pr-[2.75rem] lg:-left-[1.5rem] left-[5rem] top-[0.75rem] group-hover:block overflow-x-hidden astro-5KNYCIEN">
                        <li class=" astro-5KNYCIEN">
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">ERPNext</a>
                        </li>
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Service Now</a>
                        </li>
                      </ul>
                    </span>
                  </li>
                ...
                <li class="block lg:inline-block lg:mt-0 mr-5 text-[#31393C] astro-5KNYCIEN">
                    <span class="group relative inline-block astro-5KNYCIEN">
                      ...
                      <ul class="sub-menu absolute z-10 hidden submenu-bg lg:top-[4.1rem] py-2 pr-[2.75rem] lg:-left-[1.5rem] left-[5rem] top-[0.75rem] group-hover:block overflow-x-hidden astro-5KNYCIEN">
                        ...
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Textile</a>
                        </li>
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Healthcare</a>
                        </li>
                        <li class=" astro-5KNYCIEN">  
                        ...
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Construction</a>
                        </li>
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Crowdfunding</a>
                        </li>
                        <li class=" astro-5KNYCIEN">
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Human Resources</a>
                        </li>
                        <li class=" astro-5KNYCIEN">  
                            <a class="whitespace-pre block  text-[#4D5F66] hover:text-[#3E96F4] py-2 lg:px-5 px-5 text-sm md:text-base astro-5KNYCIEN" href="#">Ayurveda</a>
                        </li>   
                      </ul>
                    </span>
                  </li>
                ...
                <li class="block  lg:inline-block lg:mt-0 mr-5 text-[#31393C] astro-5KNYCIEN">
                    <a href="/migoo-case-study" class="text-sm md:text-base astro-5KNYCIEN"> Case Study</a>
                </li>
                <!-- <li
                    class="block  lg:inline-block lg:mt-0 mr-5 text-[#31393C]"
                >
                ...
                <li class="block  lg:inline-block lg:mt-0 mr-5 text-[#31393C] astro-5KNYCIEN">
                    <a href="#" class="text-sm md:text-base astro-5KNYCIEN"> Contact</a>
                </li>
                <li class="bg-[#3E96F4] inline-block px-4 py-1 !leading-8 rounded-md text-white drop-shadow-md font-semibold font-inter astro-5KNYCIEN">
                    <a href="#" class="text-sm md:text-base astro-5KNYCIEN">Inquire Now</a>
                </li>
            </ul>
        </div>
    </div>
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<section class="bg-[#3E96F4] flex flex-wrap relative mt-[3.125rem] md:mt-[3.125rem] lg:mt-[6.25rem] astro-K2F5ZB5C">
    ...
    <div class="mx-5 md:max-w-7xl md:mx-auto w-full md:w-7/12 md:px-24 p-0 py-3 md:p-10 astro-K2F5ZB5C">
        <h4 class="font-semibold text-white text-2xl md:text-3xl lg:text-4xl astro-K2F5ZB5C">
            Let's craft awesomeness together!
        </h4>
        <div class="mt-5 flex justify-between bg-white rounded-lg px-5 py-3 w-56 astro-K2F5ZB5C">
            <a href="#" class="text-[#3E96F4] text-sm md:text-base font-semibold font-inter astro-K2F5ZB5C">Fill up a form now.</a>
...
<footer class="bg-[#31393C] py-20 astro-K2F5ZB5C">
    <!-- <div class="md:max-w-7xl md:mx-auto md:px-24 flex flex-wrap text-white">
        <div class="sm:w-full md:w-3/12 lg:w-3/12">
            <Image src="'../../public/footer_logo.svg" />
    ...
    <div class="md:max-w-7xl mx-5 md:mx-auto md:px-24 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 md:gap-7lg:gap-10 text-white astro-K2F5ZB5C">
        ...
        <div class=" astro-K2F5ZB5C">
            <h4 class="!text-base text[#F7FFFF] font-bold font-montserrat astro-K2F5ZB5C">ServiceNow</h4>
            <div class="grid gap-2 md:gap-3 lg:gap-5 mt-5 astro-K2F5ZB5C">
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">ServiceNow Development</p>
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">ServiceNow Partner</p>
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">ServiceNow Consultation</p>
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">Hire ServiceNow Developer</p>
            </div>
        </div>
        <div class=" astro-K2F5ZB5C">
            <h4 class="!text-base text[#F7FFFF] font-bold font-montserrat astro-K2F5ZB5C">ERPNext</h4>
            <div class="grid gap-2 md:gap-3 lg:gap-5 mt-5 astro-K2F5ZB5C">
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">ERPNext Partner</p>
                <p class="b astro-K2F5ZB5C"></p><p class="text-sm astro-K2F5ZB5C">ERPNext Amazon Integration</p>
            </div>
        </div>
        <div class=" astro-K2F5ZB5C">
            <h4 class="!text-base text[#F7FFFF] font-bold font-montserrat astro-K2F5ZB5C">Contact</h4>
                <div class="!text-sm mt-5 astro-K2F5ZB5C">
                  <a href="https://www.google.com/maps/search/A-706,+Privilon,+Behind+Iscon+Temple,+Iscon+cross+Road,+SG+Highway,+Ahmedabad./@23.0282855,72.5032655,17z/data=!3m1!4b1?entry=ttu" class="flex gap-2 astro-K2F5ZB5C">${renderComponent($$result, "Image", $$Image, { "src": map, "alt": "map", "class": "astro-K2F5ZB5C" })} A-706, Privilon, Behind Iscon</a>
                  ...
                  <a href="mailto:info@sanskartechnolab.com" class="mt-7 flex gap-2 astro-K2F5ZB5C">${renderComponent($$result, "Image", $$Image, { "src": email, "alt": "email", "class": "astro-K2F5ZB5C" })}<p class="astro-K2F5ZB5C">info@sanskartechnolab.com</p></a>
                  <a href="tel:+91 9558112081" class="mt-3 flex gap-2 astro-K2F5ZB5C">${renderComponent($$result, "Image", $$Image, { "src": phone, "alt": "phone", "class": "astro-K2F5ZB5C" })}<p class="astro-K2F5ZB5C">(+91) 95581 12081</p></a>
                </div> 
              </div>
        </div>
...
<section class="bg-[#04000E] astro-K2F5ZB5C">
    <p class="md:max-w-7xl md:mx-auto md:px-24 text-center p-4 astro-K2F5ZB5C">
...
const impactful_story = {"src":"/_astro/impactful-story.281eae9b.svg","width":483,"height":486,"format":"svg"};
...
const brilliant_working = {"src":"/_astro/brilliant_working.f5a225a8.jpg","width":938,"height":693,"format":"jpg"};

const $$Astro = createAstro();
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Sanskar About-us Page", "class": "astro-KH7BTL4R" }, { "default": ($$result2) => renderTemplate`
	${maybeRenderHead()}<main class="astro-KH7BTL4R">
	<section class="section-bg-right astro-KH7BTL4R">
		...
		<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 flex lg:hidden flex-wrap items-center justify-between pt-10 pb-5 h-[calc(100vh-9vh)] astro-KH7BTL4R">
			...
			${renderComponent($$result2, "Image", $$Image, { "src": about_banner, "alt": "banner image", "class": "mt-5 astro-KH7BTL4R", "width": 1002, "height": 616 })}
		</div>
	</section>
	...
	<section class="pb-[3.125rem] md:pb-[3.125rem] lg:pb-[6.25rem] astro-KH7BTL4R">
		...
		<section class="section-bg-left py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] astro-KH7BTL4R">
				...
				<div class="ml-0 md:ml-0 lg:ml-[0rem] xl:ml-[-4.375rem] astro-KH7BTL4R">
					<div class="flex gap-4 md:gap-4 lg:gap-6 astro-KH7BTL4R">
						...
						<div class="pb-2 md:pb-3 lg:pb-4 astro-KH7BTL4R">
							<h4 class="pb-2 text-base md:text-lg lg:text-xl leading-5 md:leading-6 lg:leading-7 font-semibold text-[#31393C] astro-KH7BTL4R">Our Mission</h4>
					...
					<div class="flex gap-4 md:gap-4 lg:gap-6 astro-KH7BTL4R">
						...
						<div class="pb-2 md:pb-3 lg:pb-4 astro-KH7BTL4R">
							<h4 class="pb-2 text-base md:text-lg lg:text-xl leading-5 md:leading-6 lg:leading-7 font-semibold text-[#31393C] astro-KH7BTL4R">Our Approach</h4>
					...
					<div class="flex gap-4 md:gap-4 lg:gap-6 astro-KH7BTL4R">
						...
						<div class="pb-2 md:pb-3 lg:pb-4 astro-KH7BTL4R">
							<h4 class="pb-2 text-base md:text-lg lg:text-xl leading-5 md:leading-6 lg:leading-7 font-semibold text-[#31393C] astro-KH7BTL4R">In Action</h4>
					...
					<div class="flex gap-4 md:gap-4 lg:gap-6 astro-KH7BTL4R">
						...
						<div class="pb-0 md:pb-3 lg:pb-4 astro-KH7BTL4R">
							<h4 class="pb-2 text-base md:text-lg lg:text-xl leading-5 md:leading-6 lg:leading-7 font-semibold text-[#31393C] astro-KH7BTL4R">Join Our Drive to Innovation</h4>
			...
			<div class="hidden lg:block mx-5 md:max-w-7xl md:mx-auto md:px-24 pt-[3.125rem] md:pt-[3.125rem] lg:pt-[6.25rem] astro-KH7BTL4R">
				<div class="bg-image bg-cover bg-no-repeat bg-center md:bg-contain md:bg-right h-96 grid p-16 pt-24 items-center astro-KH7BTL4R">
					...
					<div class="flex justify-between bg-white rounded-lg lg:px-4 xl:px-5 py-2 w-56 astro-KH7BTL4R">
								<a href="#" class="text-[#3E96F4] font-semibold text-base font-inter astro-KH7BTL4R">Book a free demo.</a>
		...
		<section class="astro-KH7BTL4R">
			<div class="mx-5 md:max-w-7xl py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] md:mx-auto md:px-24 astro-KH7BTL4R">
				...
				<div class="grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mt-8 md:mt-10 lg:mt-14 mb-0 md:mb-0 lg:mb-0 gap-6 md:gap-10 lg:gap-14 astro-KH7BTL4R">
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="pb-0 md:pb-0 lg:pb-1 text-[#31393C] leading-7 md:leading-8 lg:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">Innovative minds!</h4>
					...
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="pb-0 md:pb-0 lg:pb-1 text-[#31393C] leading-7 md:leading-8 lg:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">Continuous Learning.</h4>
					...
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="pb-0 md:pb-0 lg:pb-1 text-center text-[#31393C] leading-7 md:leading-8 lg:leading-8 xl:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">The customer at the center!</h4>
					...
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="pb-0 md:pb-0 lg:pb-1 text-[#31393C] leading-7 md:leading-8 lg:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">Ethical Standards.</h4>
					...
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="text-center pb-0 md:pb-0 lg:pb-1 text-[#31393C] leading-7 md:leading-8 lg:leading-8 xl:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">End-to-end collaboration.</h4>
					...
					<div class="flex flex-col items-center astro-KH7BTL4R">
						...
						<h4 class="pb-0 md:pb-0 lg:pb-1 text-[#31393C] leading-7 md:leading-8 lg:leading-9 text-base md:text-lg lg:text-xl font-semibold astro-KH7BTL4R">Adaptability</h4>
		...
		<section class="mx-5 md:max-w-7xl md:mx-auto md:px-24 text-center py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] astro-KH7BTL4R">
		...
		<section class="py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] astro-KH7BTL4R">
		...
		<section class="section-bg-center astro-KH7BTL4R">
			<div class="mx-5 md:max-w-7xl md:mx-auto md:px-24 py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] astro-KH7BTL4R">
		...
		<section class="py-[3.125rem] md:py-[3.125rem] lg:py-[6.25rem] astro-KH7BTL4R">
            ...
            ${renderComponent($$result2, "Image", $$Image, { "class": " astro-KH7BTL4R", "src": impactful_story, "alt": "Impactful Story", "width": 483, "height": 486 })}
				...
				<div class="astro-KH7BTL4R">
					...
					<p class="text-[#31393C]  pb-2 md:pb-4 lg:pb-6 leading-4 md:leading-5 lg:leading-6 text-xs md:text-sm lg:text-base font-normal astro-KH7BTL4R">Sanskar Technolab was started over 12 years back by Anand Thakker. He started with a clear mission & vision to leverage the best technologies and tools and serve businesses with the best-in-class results by adopting the best practices, target market preferences, and latest trends.</p>
					<p class="text-[#31393C]  pb-2 md:pb-4 lg:pb-6 leading-4 md:leading-5 lg:leading-6 text-xs md:text-sm lg:text-base font-normal astro-KH7BTL4R"> Since our inception, we have covered different areas of excellence with constant innovation and personalized solutions by keeping our clients at the center.</p>
					<p class="text-[#31393C]  pb-2 md:pb-4 lg:pb-6 leading-4 md:leading-5 lg:leading-6 text-xs md:text-sm lg:text-base font-normal astro-KH7BTL4R">So, we at Sanskar Technolabs have, are, and will continue to serve desired solutions for our clients and their end customers.</p>
				</div>
			</div>
		</section>
	</main>
...
export { $$Image as $, BaseSSRService as B, $$Layout as a, about as b, error as e, isRemoteImage as i, metadata as m, right as r };
